...
document.getElementById('english').addEventListener('click', function() {
  document.getElementById('mainFlag').src = 'assets/images/icon-flag-en.svg';
});

document.getElementById('malay').addEventListener('click', function() {
  document.getElementById('mainFlag').src = 'assets/images/flag/malaysia.png';
});

document.getElementById('toggle-icon').addEventListener('click', function() {
    var moonIcon = document.getElementById('moon-icon');
    var sunIcon = document.getElementById('sun-icon');
    var isDarkTheme = $('html').attr('data-bs-theme') === 'dark';
